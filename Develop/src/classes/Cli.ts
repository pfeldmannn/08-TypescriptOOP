  ...
  performActions(): void {
    inquirer
      ...
      .then((answers: { action: string; }) => {
        ...
        // DONE: add statements to perform the tow action only if the selected vehicle is a truck. Call 
        //the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. 
